...
3. Cut the work into **vertical slices** per `../shared/vertical-slices.md`, each declaring its blocking edges. Sequence any prefactoring first — "make the change easy, then make the easy change" (Kent Beck). Note risks, unknowns, and files to touch.
