...
> Adapted from [Matt Pocock's `grilling` skill](https://github.com/mattpocock/skills) (formerly `grill-me`),
> MIT-licensed. This version diverges in two ways: it grills **one question at a time** rather than in
